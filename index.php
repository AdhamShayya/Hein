...
<body>
		<nav class="navbar">
			<form method="POST" class="navbar-container container">
				<ul class="menu-items">
					<li class=" marr"><h1 class="logo">AA Cafe</h1></li>
					<li class=" marr"><a href="#home">Home</a></li>
					<li class="marr"><a href="#about">About</a></li>
					<li class="marr"><button name="menu" class="btn btn-dark" style="color: white">Menu</button></li>
					<li class="marr"><a href="#contact">Contact</a></li>
					<?php
					...
					<div class="col-sm-3 marr">
						<div class="card" style="width:300px;">
							...
							<div class="card-body">
								...
								<form method="post">
								<button name="menu" class="btn btn-dark" style="color: white">Here</button>
				</form>
							</div>
						</div>
					</div>
